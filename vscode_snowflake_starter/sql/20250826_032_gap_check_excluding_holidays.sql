-- File: sql/20250826_032_gap_check_excluding_holidays.sql
-- Title: Stage 1  Gap check excluding weekends + NYSE holidays
WITH rng AS (
...
missing AS (
  ...
  LEFT JOIN HOLIDAYS_NYSE h
    ON h.HOLIDAY_DATE = c.D
