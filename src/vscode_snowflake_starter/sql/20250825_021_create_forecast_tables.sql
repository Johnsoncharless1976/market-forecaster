-- File: vscode_snowflake_starter/sql/20250825_021_create_forecast_tables.sql
-- Title: Stage 2  Create FEATURES_DAILY & FORECAST_DAILY (with explicit context)
-- Commit Notes:
-- - Ensures correct ROLE/DB/SCHEMA, then idempotent CREATEs.
