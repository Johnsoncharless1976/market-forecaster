...
```
cd existing_repo
git remote add origin https://gitlab.com/zenmarketai/market-forecaster.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/zenmarketai/market-forecaster/-/settings/integrations)
